...
<head>
    ...
    <title>Check Out | Men Bay - Shopper</title>
...
<c:choose>
    <c:when test="${Order.orderDetailsList != null}">
                            ...
                            <c:forEach var="x" items="${s.productId.productSizeColorList}">
                                <tr>
                                    <td class="cart_product">
                                        <a href="productDetails?id=${s.productId.id}" target="_blank"><img src="<c:url value="/template/user/images/cart/three.png"/>" alt=""></a>
                                    </td>
                                    <td class="cart_description">
                                        <h4><p><a href="productDetails?id=${s.productId.id}" target="_blank">&emsp;&emsp;${s.productId.name}</a></p></h4>
                                        ...
                                        <div class="cart_quantity_button">
                                            <c:choose>
                                                <c:when test="${s.quantity == x.quantity}">
                                                    <a style="pointer-events: none" class="cart_quantity_up" href="#"> + </a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a class="cart_quantity_up" href="plusItemCheckOut?iditem=${x.id}"> + </a>
                                                </c:otherwise>
                                            </c:choose>
                                            ...
                                            <c:choose>
                                                <c:when test="${s.quantity == 1}">
                                                    <a style="pointer-events: none" class="cart_quantity_down" href="#"> - </a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a class="cart_quantity_down" href="lessItemCheckOut?iditem=${x.id}"> - </a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </td>
                                    ...
                                    <td class="cart_delete">
                                        <a class="cart_quantity_delete" href="deleteItem?iditem=${x.id}"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:forEach>
        ...
        <br>
        <div style="position: relative;"><a style="position: absolute;top: 80%;left: 20%;transform: translate(-50%, -50%)" href="homePage" class="btn btn-default check_out"><i
        ...
        <section id="do_action">
            <div class="container">
                ...
                <mvc:form modelAttribute="Orderr" action="userCheckOut" method="get">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="chose_area">
                                <ul class="user_info">
                                    <label>* Your Name:</label>
                                    <mvc:input path="shipmentId.customerName" value="${customer.name}" type="text" required="required" title="Please enter your name!"/>
                                </ul>
                                <ul class="user_info">
                                    <label>* Address:</label>
                                    <mvc:input path="shipmentId.address" value="${customer.address}" type="text" required="required" minlength="5" title="Please enter your address!"/>
                                </ul>
                                <ul class="user_info">
                                    <label>* Email:</label>
                                    <mvc:input path="accountId.customer.email" value="${customer.email}" type="text" required="required" pattern="^[a-z][a-z0-9_\.]{5,32}@[a-z0-9]{2,}(\.[a-z0-9]{2,4}){1,2}$" title="Please enter your address!"/>
                                </ul>
                                <ul class="user_info">
                                    <li class="single_field zip-field">
                                        <label>* Number Phone:</label>
                                        <mvc:input path="shipmentId.phone" value="${customer.phone}" type="number" required="required" maxlength="13" minlength="8" title="invalid phone number!"/>
                                    </li>
                                    <li class="single_field zip-field">
                                        <label>Code Promo:</label>
                                        <mvc:input path="promoId.code" type="text" pattern="[A-Za-z0-9_]{6}" title="Please enter correctly!"/>
                                    </li>
                                    <li class="single_field zip-field">
                                        <label>* Payment methods:</label>
                                        <mvc:select path="paymentId.id" >
                                            <mvc:option value="1">Direct payment</mvc:option>
                                            <mvc:option value="2">Online payment</mvc:option>
                                        </mvc:select>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="total_area">
                                <ul>
                                    <li>Cart Sub Total <span><c:out value="${Order.amount}"/></span></li>
                                    <li>VAT (5%) <span><c:out value="${Order.amount + Order.amount*5/100}"/> </span></li>
                                    <li>Shipping Cost <span>Free</span></li>
                                    <li>Total <span><c:out value="${Order.amount + Order.amount*5/100}"/></span></li>
                                </ul>
                                <button type="submit" class="btn btn-default check_out" >Check Out <i class="fa fa-arrow-circle-right"></i></button>
                            </div>
                        </div>
                    </div>
                </mvc:form>
    ...
    <c:otherwise>
        ...
        <br>
        <br>
        <div style="position: relative;"><p style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%)"><img src="<c:url value="/template/user/images/home/cartEmpty.png"/>"></p></div>
        <br>
        <br>
        <br>
        <br>
        <br>
        <br>
        <div style="position: relative;"><a style="position: absolute;top: 80%;left: 20%;transform: translate(-50%, -50%)" href="shop?page=1" class="btn btn-default check_out"><i
                class="fa fa-backward"></i>&emsp; Continue shopping</a></div>
        <br>
    </c:otherwise>
</c:choose><!--/#do_action-->
