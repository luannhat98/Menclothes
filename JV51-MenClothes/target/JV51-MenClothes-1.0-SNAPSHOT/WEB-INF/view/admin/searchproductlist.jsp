                        ...
                        <table class="data-Table">
                            ...
                            <div class="form-nav">
                                <nav class="nav-edit" aria-label="Page navigation example">
                                    <ul class="pagination ">
                                        <c:if test="${totalPage==null&&currentPage==null}">
                                            <h4>tét</h4>
                                        </c:if>
                                        ...
                                        <c:if test="${currentPage > 0}">
                                            <li class="page-item">
                                                <a class="page-link" href="?page=${currentPage - 1}&name=${name}"aria-label="Previous">
                                        ...
                                        <c:forEach var="i" begin="0" end="${totalPage - 1}">
                                            <li  class="page-item ${ i >= currentPage +3 || i <= currentPage -3 ?'accest' : ''} ${i == currentPage ?'active':''}">
                                                <a class="page-link" href="?page=${i}&name=${name}">${i + 1} </a>
                                            </li>
                                        </c:forEach>

                                        <c:if test="${currentPage < totalPage -1}">
                                            <li class="page-item">
                                                <a class="page-link" href="?page=${currentPage + 1}&name=${name}" aria-label="Next">
