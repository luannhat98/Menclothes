                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href=""><i class="fa fa-phone"></i> 0921 789 517</a></li>
            ...
            <div class="col-sm-9">
                <div class="blog-post-area">
                    ...
                    <div class="single-blog-post">
                        <h3>SƠ MI CÀI CÚC VÀ SỰ THAY ĐỔI CUỘC CHƠI TỪ BROOKS BROTHERS</h3>
                        <div class="post-meta">
                            <ul>
                        ...
                        <p>Trong phạm vi của menswear, những ý tưởng có khởi nguồn từ sartorial thường hay được mở rộng ra khỏi ngữ cảnh ban đầu và được biến tấu một cách linh hoạt để giúp cho các sản phẩm đó có thể trở nên wearable. Chiếc áo sơ mi cài cúc (the button-down shirt) là một ví dụ điển hình cho một quá trình chuyển đổi như vậy.</p>
