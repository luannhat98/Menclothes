...
<head>
    ...
    <title>Shop | Men Bay - Shopper</title>
...
<section id="advertisement">
    <div class="container">
        <img src="<c:url value="/template/user/images/shop/advertisement.jpg"/>" alt="" />
    </div>
</section>
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="1">
                            <c:forEach var="s" items="${Image}" begin="${beginProduct}" end="${endProduct}">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="<c:url value="/template/user/images/home/${s.image}.jpg"/>"
                                                     alt=""
                                                     style="width: 260px; height: 390px"/>
                                                <h2>${s.productId.price}</h2>
                                                <p>${s.productId.name}</p>
                                                <a href="productDetails?id=${s.productId.id}" target="_blank" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                ...
                <div class="pagination">
                    ...
                    <c:forEach var="b" begin="1" end="${totalPage}">
                        <c:choose>
                            <c:when test="${b == beginProduct/5+1}">
                                <a class="active" href="shop?page=${b}">${b}</a>
                            </c:when>
                            <c:otherwise>
                                <a href="shop?page=${b}">${b}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    <a href="#">&raquo;</a>
